...
//string apiKey = "SEMZP7KDS1W0CIPF"; // Substitua com sua chave de API
//string baseUrl = "https://www.alphavantage.co/query";
//string connectionString = "Host=aws-1-us-east-1.pooler.supabase.com;Port=6543;Database=postgres;User Id=postgres.[ID_SUPABASE];Password=[SENHA];SSL Mode=Require;Trust Server Certificate=true;";
